...
This software also uses third-party libraries, which remain subject to their respective original licenses. See [THIRD_PARTY_NOTICES.md](/THIRD_PARTY_NOTICES.md) for details.
